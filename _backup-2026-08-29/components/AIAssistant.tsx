      ...
      <div className="container-custom px-4 sm:px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <h2 className="relative z-10 text-4xl sm:text-5xl font-bold bg-gradient-to-r from-white via-cyan-200 to-sky-400 bg-clip-text text-transparent mb-3">
              Ask My AI Assistant
            </h2>
            <p className="text-xs sm:text-sm text-slate-500 mb-4 tracking-wide">
              <span className="text-cyan-400 font-semibold">AAA</span> — short for{' '}
              <span className="text-slate-400">Abdulaziz AI Assistant</span>
            </p>
            <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Instead of scrolling, just ask. It knows my projects, experience, and stack —
              and answers in English or Arabic.
            </p>
          </div>
              ...
              <div className="mx-5 sm:mx-6 mb-4 rounded-2xl border border-sky-500/30 bg-sky-500/10 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-sky-100/90 leading-relaxed">
                    <p className="font-semibold text-sky-200 mb-1">The assistant isn&apos;t switched on yet</p>
                    <p className="mb-2">
          ...
          <p className="text-center text-xs text-slate-600 mt-4">
            Answers come from my portfolio data — for anything else, email{' '}
