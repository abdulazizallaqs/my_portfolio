...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-gradient-to-br from-ink-950 via-[#06182E] to-ink-950 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Let&apos;s Build Something Intelligent</h2>
            <p className="text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Open to software &amp; AI engineering roles and collaborations, based in Riyadh. Tell me what you&apos;re building.
            </p>
          </div>
          ...
          <div ref={contentRef} className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-slate-400 text-sm mb-2">📧 Email: usually within 24 hours</p>
                <p className="text-slate-400 text-sm mb-4">💬 WhatsApp: fastest response</p>
            ...
            >
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-teal-500/10 border border-teal-500/30 rounded-2xl flex items-center gap-3 transform animate-pulse">
                  ...
                  <p className="text-teal-200">Message sent successfully! I'll get back to you soon.</p>
                </div>
              )}
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div style={animationVariants.fadeInUp(contentVisible, 600)}>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-ink-900/55 backdrop-blur-sm border rounded-2xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all transform hover:scale-105 ${
                        errors.name ? 'border-red-300' : 'border-cyan-500/20'
                      }`}
                  ...
                  <div style={animationVariants.fadeInUp(contentVisible, 700)}>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 bg-ink-900/55 backdrop-blur-sm border rounded-2xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all transform hover:scale-105 ${
                        errors.email ? 'border-red-300' : 'border-cyan-500/20'
                      }`}
                ...
                <div style={animationVariants.fadeInUp(contentVisible, 800)}>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-ink-900/55 backdrop-blur-sm border rounded-2xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all transform hover:scale-105 ${
                      errors.subject ? 'border-red-300' : 'border-cyan-500/20'
                    }`}
                ...
                <div style={animationVariants.fadeInUp(contentVisible, 900)}>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={5}
                    className={`w-full px-4 py-3 bg-ink-900/55 backdrop-blur-sm border rounded-2xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all resize-none transform hover:scale-105 ${
                      errors.message ? 'border-red-300' : 'border-cyan-500/20'
                    }`}
                ...
                >
                  {isSubmitting ? (
                    <>
                      <div className="w-5 h-5 border-2 border-cyan-500/20 border-t-white rounded-full animate-spin"></div>
                      Sending...
                    </>
                  ) : (
                    <>
