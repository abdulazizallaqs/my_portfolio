...
export const metadata: Metadata = {
  ...
  description:
    'Software & AI Engineer building LLM-powered products end to end: OpenAI and Gemini integration, prompt engineering, rule-based inference systems, Node.js and Python backends, Next.js and Flutter interfaces.',
  keywords: [
    'Software Engineer',
    'AI Engineer',
    'LLM Integration',
