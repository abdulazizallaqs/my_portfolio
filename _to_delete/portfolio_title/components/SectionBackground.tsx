...
const SectionBackground = ({ variant, children, className = '', id }: SectionBackgroundProps) => {
  const getBackgroundClasses = () => {
    switch (variant) {
      case 'hero':
        return 'bg-gradient-to-br from-ink-950 via-ink-900 to-black'
      case 'primary':
        return 'bg-gradient-to-br from-ink-950 via-ink-900 to-ink-950'
      case 'secondary':
        return 'bg-gradient-to-br from-ink-900 via-ink-950 to-ink-900'
      case 'tertiary':
        return 'bg-gradient-to-br from-ink-950 via-[#071A2E] to-ink-950'
      case 'quaternary':
        return 'bg-gradient-to-br from-ink-900 via-[#06182B] to-ink-950'
      default:
        return 'bg-gradient-to-br from-ink-950 via-ink-900 to-ink-950'
    }
  }
