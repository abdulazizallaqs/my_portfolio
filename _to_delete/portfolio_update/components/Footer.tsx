        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              AI Engineer building LLM-driven systems end to end — model integration, RAG pipelines, predictive analytics, and the scalable backends underneath.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#about" className="text-gray-300 hover:text-primary-400 transition-colors">Background</a></li>
              ...
              <li><a href="#certifications" className="text-gray-300 hover:text-primary-400 transition-colors">Certifications</a></li>
