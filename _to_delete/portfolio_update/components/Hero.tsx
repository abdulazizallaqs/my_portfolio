      ...
      <div className="container-custom text-center relative z-10 px-4 sm:px-6">
        ...
        <div className="mb-12 mt-16 flex justify-center">
          <div className="relative group">
            ...
            <div className="relative w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 rounded-full overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-600 to-blue-700 p-1 shadow-xl">
              <div className="w-full h-full rounded-full overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-600 to-blue-700 flex items-center justify-center">
                {/* Replace this block with <img src="/profile.jpg" ... /> once you add a photo to /public */}
                <span className="text-6xl sm:text-7xl lg:text-8xl font-bold text-white tracking-tight group-hover:scale-105 transition-all duration-500">
                  {initials}
                </span>
              </div>
            </div>
